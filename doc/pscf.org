...
- =$declarations$= - variable declaration. This contains *all* the
  variables defined in the sections
  [[*Normally%20distributed%20random%20series][Normally distributed random series]],[[*Observables][ Observables]] and
  [[*By%20formulas%20tied%20to%20the%20random%20distribution][By formulas tied to the random distribution]], declared
