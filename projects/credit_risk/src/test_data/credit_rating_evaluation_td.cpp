...
credit_rating_evaluation_generator::credit_rating_evaluation_generator() : position_(0) { }

void credit_rating_evaluation_generator::
...
credit_rating_evaluation_generator::create(const unsigned int position) {
    credit_rating_evaluation r;
