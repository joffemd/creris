...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<creris::credit_risk::time_series_configuration_unversioned_key, creris::credit_risk::time_series>& v) {
    s << "[";
