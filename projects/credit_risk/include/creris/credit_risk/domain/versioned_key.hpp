 ...
 *
 */
#ifndef CRERIS_CREDIT_RISK_DOMAIN_VERSIONED_KEY_HPP
#define CRERIS_CREDIT_RISK_DOMAIN_VERSIONED_KEY_HPP
...
#include "creris/credit_risk/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    creris::credit_risk::versioned_key& lhs,
    creris::credit_risk::versioned_key& rhs) {
    lhs.swap(rhs);
}
