 ...
 *
 */
#ifndef CRERIS_CREDIT_RISK_DOMAIN_TIME_SERIES_CONFIGURATION_UNVERSIONED_KEY_HPP
#define CRERIS_CREDIT_RISK_DOMAIN_TIME_SERIES_CONFIGURATION_UNVERSIONED_KEY_HPP
