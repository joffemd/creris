 ...
 *
 */
#ifndef CRERIS_CREDIT_RISK_SERIALIZATION_RATINGS_MAP_UNVERSIONED_KEY_SER_HPP
#define CRERIS_CREDIT_RISK_SERIALIZATION_RATINGS_MAP_UNVERSIONED_KEY_SER_HPP
