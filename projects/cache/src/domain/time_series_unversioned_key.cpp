...
time_series_unversioned_key::time_series_unversioned_key()
    : id_(static_cast<unsigned int>(0)) { }

time_series_unversioned_key::time_series_unversioned_key(const unsigned int id)
    : id_(id) { }
...
bool time_series_unversioned_key::operator==(const time_series_unversioned_key& rhs) const {
    return id_ == rhs.id_;
}
