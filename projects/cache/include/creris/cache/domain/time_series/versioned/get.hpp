 ...
 *
 */
#ifndef CRERIS_CACHE_DOMAIN_TIME_SERIES_VERSIONED_GET_HPP
#define CRERIS_CACHE_DOMAIN_TIME_SERIES_VERSIONED_GET_HPP
...
#include <algorithm>
#include "creris/cache/serialization/time_series/versioned/get_fwd_ser.hpp"
...
public:
    explicit get(const creris::credit_risk::model_configuration_unversioned_key& key);
...
template<>
inline void swap(
    creris::cache::time_series::versioned::get& lhs,
    creris::cache::time_series::versioned::get& rhs) {
    lhs.swap(rhs);
}
