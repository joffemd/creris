 ...
 *
 */
#ifndef CRERIS_PROTOCOL_DOMAIN_UNVERSIONED_KEY_HPP
#define CRERIS_PROTOCOL_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "creris/protocol/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    creris::protocol::unversioned_key& lhs,
    creris::protocol::unversioned_key& rhs) {
    lhs.swap(rhs);
}
