 ...
 *
 */
#ifndef CRERIS_PROTOCOL_DOMAIN_VERSIONED_KEY_HPP
#define CRERIS_PROTOCOL_DOMAIN_VERSIONED_KEY_HPP
...
#include "creris/protocol/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    creris::protocol::versioned_key& lhs,
    creris::protocol::versioned_key& rhs) {
    lhs.swap(rhs);
}
