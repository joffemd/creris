 ...
 *
 */
#ifndef CRERIS_BATCHER_DOMAIN_EVALUATION_REQUEST_HPP
#define CRERIS_BATCHER_DOMAIN_EVALUATION_REQUEST_HPP
...
#include <algorithm>
#include "creris/batcher/serialization/evaluation_request_fwd_ser.hpp"
...
template<>
inline void swap(
    creris::batcher::evaluation_request& lhs,
    creris::batcher::evaluation_request& rhs) {
    lhs.swap(rhs);
}
