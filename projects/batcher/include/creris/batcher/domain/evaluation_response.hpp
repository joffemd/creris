 ...
 *
 */
#ifndef CRERIS_BATCHER_DOMAIN_EVALUATION_RESPONSE_HPP
#define CRERIS_BATCHER_DOMAIN_EVALUATION_RESPONSE_HPP
...
#include <algorithm>
#include "creris/batcher/serialization/evaluation_response_fwd_ser.hpp"
...
template<>
inline void swap(
    creris::batcher::evaluation_response& lhs,
    creris::batcher::evaluation_response& rhs) {
    lhs.swap(rhs);
}
